...
#pragma pack(push, 1)
	export struct TMapPlayerObj : public TMapMoveObjBase
	{
		...
		struct NosTaleSDK::Entwell::Properties::Graphical::WeaponGlowing weaponGlowing;	// 0x1C4
		char unknown96[26];																// 0x1D6
		struct NosTaleSDK::Entwell::Properties::Logical::String* unknown97;				// 0x1F0
		struct NosTaleSDK::Entwell::Properties::Logical::String* unknown98;				// 0x1F4
		struct NosTaleSDK::Entwell::Properties::Logical::String* unknown99;				// 0x1F8

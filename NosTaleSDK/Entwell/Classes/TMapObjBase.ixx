...
#pragma pack(push, 1)
	export struct TMapObjBase : public TObject
	{
		...
		struct NosTaleSDK::Entwell::Properties::Logical::Position position;		// 0x00C
		...
		struct TSmallIntList* unknown5;											// 0x028 probably same as above but for unknown4
		struct NosTaleSDK::Entwell::Properties::Graphical::Bgra entityColor;	// 0x02C Note: changing alpha will not work, change the variable below

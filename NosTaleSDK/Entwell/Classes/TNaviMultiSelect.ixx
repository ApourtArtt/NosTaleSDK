...
#pragma pack(push, 1)
	...
	{
		Properties::Logical::Position mousePosition;					// 0x024
		TList<struct TMapNpcObj*>* selectedEntities;					// 0x028 except controlled entity
		TList<struct TSvrCtlObjManager*>* selectedEntitiesController;	// 0x02C except controlled entity

...
#pragma pack(push, 1)
	export struct TSceneManager : public TObject
	{
		...
		Properties::Logical::Position cursorPosition;	// 0x04C
		int16_t windowWidth;							// 0x050
		int16_t windowHeight;							// 0x052
		Properties::Logical::Position targetSkillPos;	// 0x054
		...
		TList<void*>* unknown11;						// 0x070
		TList<void*>* unknown12;						// 0x074
		TList<void*>* unknown13;						// 0x078
		TList<void*>* unknown14;						// 0x07C
		TList<void*>* unknown15;						// 0x080
		TList<struct TLBSBkFxItem*>* fxList;			// 0x084

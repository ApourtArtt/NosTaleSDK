...
#pragma pack(push, 1)
	export struct TEWLabels : public TEWControlWidgetEX
	{
		...
		Properties::Graphical::TextStyle textStyle;					// 0x06D
		Properties::Logical::Position textPadding;					// 0x078
		Properties::Logical::Position textPosition;					// 0x07C
		Properties::Graphical::TextStyle* textStylePtr;				// 0x080
		Properties::Graphical::TextStyle** textPositionArrayPtr;	// 0x084
	};

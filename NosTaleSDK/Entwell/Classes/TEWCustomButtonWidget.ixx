...
#pragma pack(push, 1)
	export struct TEWCustomButtonWidget : public TEWCustomPanelWidget
	{
		...
		Properties::Logical::Callback callback;			// 0x0B0
		Properties::Logical::Callback unknownCallback;	// 0x0B8
		...
		Properties::Logical::Callback unknownCallback2;	// 0x0C8
		Properties::Logical::Callback unknownCallback3;	// 0x0D0
	};

...
#pragma pack(push, 1)
	...
	export struct TApplication : public TComponent
	{
		...
		Properties::Logical::DelphiArray<char>* bidirectionalKeyboard;		// 0x038
		Properties::Logical::DelphiArray<char>* nonBidirectionalKeyboard;	// 0x03C
		void* comObject;													// 0x040
		struct TNosTaleMainF* mainForm;										// 0x044
		struct TControl* mouseControl;										// 0x048
		void* helpSystem;													// 0x04C
		Properties::Logical::DelphiArray<char>* helpFile;					// 0x050
		Properties::Logical::DelphiArray<char>* hint;						// 0x054
		...
		Properties::Logical::DelphiArray<char>* title;						// 0x08C

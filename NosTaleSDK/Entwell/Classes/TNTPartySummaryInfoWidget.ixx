...
#pragma pack(push, 1)
	export struct TNTPartySummaryInfoWidget : public TEWCustomPanelWidget
	{
		...
		TEWLabel* pseudonym;												// 0x0AC
		struct TNTMaskingGaugeWidget* gaugeHp;								// 0x0B0
		TNTMaskingGaugeWidget* gaugeMp;										// 0x0B4
		...
		TEWControlWidgetEX* firstPartyMemberTargetCircle;					// 0x0C8
		TEWControlWidgetEX* firstPartyMemberUnusedImage;					// 0x0CC
		bool isFirstPartyMemberFollow;										// 0x0D0
		bool isFirstPartyMemberControlled;									// 0x0D1
		char unknown34[2];													// 0x0D2
		TEWControlWidgetEX* firstPartyMemberPowerSeed;						// 0x0D4

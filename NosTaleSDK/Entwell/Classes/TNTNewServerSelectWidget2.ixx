...
#pragma pack(push, 1)
	export struct TNTNewServerSelectWidget2 : public TEWControlWidgetEX
	{
		...
		TEWCustomPanelWidget* unknown24;			// 0x078
		uint32_t unknown25;							// 0x07C
		TEWControlWidgetEX* serverTrackerWidget;	// 0x080
		char unknown26[100];						// 0x084
		uint32_t unknown27;							// 0x0E8
		TEWCustomPanelWidget* unknown28;			// 0x0EC
		TEWCustomPanelWidget* unknown29;			// 0x0F0
		TEWLabel* unknown30;						// 0x0F4
		TEWLabel* unknown31;						// 0x0F8
		TEWListView* unknown32;						// 0x0FC
		TEWListView* unknown33;						// 0x100
		TEWGraphicButtonWidget* unknown34;			// 0x104
		TEWGraphicButtonWidget* unknown35;			// 0x108
		TEWCustomPanelWidget* unknown36;			// 0x10C
		TEWCustomPanelWidget* unknown37;			// 0x110
		uint32_t unknown38;							// 0x114
		uint32_t unknown39;							// 0x118
		TEWControlWidgetEX* unknown40;				// 0x11C

...
#pragma pack(push, 1)
	export struct TEWCaptionBar : public TEWParentMoveWidget
	{
		...
		struct NosTaleSDK::Entwell::Properties::Graphical::TextStyle textStyle;			// 0x096
		char unknown32[3];																// 0x0A1
		struct NosTaleSDK::Entwell::Properties::Graphical::TextPosition textPosition;	// 0x0A4
	};

...
#pragma pack(push, 1)
	export struct TEWLabel : public TEWControlWidgetEX
	{
		...
		struct NosTaleSDK::Entwell::Properties::Graphical::TextStyle textStyle;			// 0x06A
		char unknown22[3];																// 0x075
		struct NosTaleSDK::Entwell::Properties::Graphical::TextPosition textPosition;	// 0x078

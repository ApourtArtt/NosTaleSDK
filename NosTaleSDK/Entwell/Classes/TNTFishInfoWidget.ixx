...
#pragma pack(push, 1)
	export struct TNTFishInfoWidget : public TEWCustomFormWidget
	{
		...
		struct TEWCustomPanelWidget* unknown43;				// 0x0D0
		...
		struct TList<void*>* unknown49;						// 0x144
		char unknown50[4];									// 0x148
		struct TEWListView* unknown51;						// 0x14C
		struct TEWGraphicButtonWidget* unknown52;			// 0x150
		struct TEWCustomPanelWidget* unknown53;				// 0x154
		struct TEWControlWidgetMouseEvent* unknown54;		// 0x158
		struct TEWCustomPanelWidget* unknown55;				// 0x15C

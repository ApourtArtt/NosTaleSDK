...
#pragma pack(push, 1)
	export struct TNTNosMallTotalWidget : public TEWCustomFormWidget
	{
		...
		struct TEWControlWidgetEX* unknown46;								// 0x0D4
		struct TEWGraphicButtonWidget* unknown47;							// 0x0D8
		struct TEWGraphicButtonWidget* unknown48;							// 0x0DC
		struct TEWGraphicButtonWidget* unknown49;							// 0x0E0
		struct TEWGraphicButtonWidget* unknown50;							// 0x0E4
		...
		struct NosTaleSDK::Entwell::Properties::Logical::String* unknown56;	// 0x0F8
		struct NosTaleSDK::Entwell::Properties::Logical::String* unknown57;	// 0x0FC
		uint32_t unknown58;													// 0x100
		uint32_t dispatch;													// 0x104
		char unknown59[4];													// 0x108
		uint8_t unknown60;													// 0x10C
		char unknown61[3];													// 0x10D
		struct NosTaleSDK::Entwell::Properties::Logical::String* unknown62;	// 0x110
	};

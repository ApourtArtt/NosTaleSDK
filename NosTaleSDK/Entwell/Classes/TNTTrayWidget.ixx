...
#pragma pack(push, 1)
	export struct TNTTrayWidget : public TEWControlWidgetEX
	{
		...
		Properties::Logical::String* unknown24;		// 0x078
		Properties::Logical::String* unknown25;		// 0x07C
		Properties::Logical::String* unknown26;		// 0x080
		Properties::Logical::String* unknown27;		// 0x084
		Properties::Logical::String* unknown28;		// 0x088
		Properties::Logical::String* unknown29;		// 0x08C
		Properties::Logical::String* unknown30;		// 0x090
		Properties::Logical::String* unknown31;		// 0x094
		Properties::Logical::String* unknown32;		// 0x098
		Properties::Logical::String* unknown33;		// 0x09C
		Properties::Logical::String* unknown34;		// 0x0A0
		Properties::Logical::String* unknown35;		// 0x0A4
		Properties::Logical::String* unknown36;		// 0x0A8
		Properties::Logical::String* unknown37;		// 0x0AC
		Properties::Logical::String* unknown38;		// 0x0B0
		Properties::Logical::String* unknown39;		// 0x0B4
		...
		Properties::Logical::String* unknown51;		// 0x130
		Properties::Logical::String* unknown52;		// 0x134
		Properties::Logical::String* unknown53;		// 0x138
		Properties::Logical::String* unknown54;		// 0x13C

...
#pragma pack(push, 1)
	export struct TNTNewCharacterStandardInfoWidget : public TEWCustomFormWidget
	{
		...
		struct TEWControlWidgetEX* unknown42;													// 0x02FC 
		struct TEWControlWidgetEX* unknown43;													// 0x0300 
		...
		struct TNTItemList* unknown44;															// 0x043C 
		struct TNTItemList* unknown45;															// 0x0440
		struct TNTItemList* unknown46;															// 0x0444
		...
		struct TNTItemList* unknown49;															// 0x06E4 
		struct TNTItemList* unknown50;															// 0x06E8

...
#pragma pack(push, 1)
	export struct TNTCharacterSummaryInfoWidget : public TEWCustomFormWidget
	{
		...
		TNTMaskingGaugeWidget* unknown42;					// 0x0C8
		struct TNTItemList* unknown43;						// 0x0CC
		TNTItemList* unknown44;								// 0x0D0
		...
		TEWLabelWithHint* unknown53;						// 0x118

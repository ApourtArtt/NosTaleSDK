...
#pragma pack(push, 1)
	export struct TNTIconWidget : public TEWControlWidgetEvent
	{
		...
		Properties::Logical::Callback unknown23;		// 0x078
		Properties::Logical::Position clickPosition;	// 0x080
		bool isTransparent;								// 0x084
		bool unknown24;									// 0x085
		char unknown25[2];								// 0x086
		float unknown26;								// 0x088
		char unknown27[4];								// 0x08C
		Properties::Logical::Callback unknown28;		// 0x090
		Properties::Logical::Callback unknown29;		// 0x098
		...
		Properties::Graphical::Icon* icon;				// 0x0A8

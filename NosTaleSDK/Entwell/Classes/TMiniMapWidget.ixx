...
#pragma pack(push, 1)
	export struct TMiniMapWidget : public TMiniMapCore
	{
		...
		TList<void*>* unknown31;					// 0x0A4
		TList<void*>* unknown32;					// 0x0A8
		TList<void*>* unknown33;					// 0x0AC
		TList<TMapNpcObj>* npcsList;				// 0x0B0
		TList<void*>* unknown34;					// 0x0B4
		TList<struct TMapMonsterObj*>* bossList;	// 0x0B8
		TList<void*>* unknown35;					// 0x0BC
		TList<void*>* unknown36;					// 0x0C0

...
#pragma pack(push, 1)
	export struct TNaviMultiSelect : public TLBSWidget
	{
		...
		TList<struct TMapNpcObj*>* selectedEntities;							// 0x28 NOTE: Character is not in it even when selected
		TList<struct TSvrCtlObjManager*>* selectedEntitiesController;			// 0x2C NOTE: Character is not in it even when selected
